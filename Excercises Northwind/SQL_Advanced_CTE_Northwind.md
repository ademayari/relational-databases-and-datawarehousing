...
--If not given a name, it will use the 'default' name
(e.g. customerid, COUNT(orderid))

--Or you can specify the columnname in the
'header' of the CTE
...
-- Give the products that cost more than the average price of products
...
-- Give the total revenue per month in 2016.
...
/_ Recursively traversing a hierarchical structure _/
